...
export default function About() {
    return (
        <div>
            ...
            <br></br>
            <p>
            I'm interested in all aspects of content creation, with a current focus on web design work. I have a strong interest in narrative and interactivity, and I'm looking for an opportunity to join a team of professionals interested in creating meaningful, compelling content.
            </p>
        </div>
